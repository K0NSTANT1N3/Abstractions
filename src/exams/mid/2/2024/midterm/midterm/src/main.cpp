...
bool runCircleSingleTest(int testNum) {
	...
	case 2:
		c->insert(0, 5);
		passed = c->length() == 1 && c->get(0) == 5 && c->get(5) == 5;
		break;
	case 3:
		c->insert(0, 2);
		c->insert(0, 1);
		c->insert(2, 4);
		passed = c->length() == 3 && equalsCircle("124", c) &&
				c->get(4) == 2 && c->get(8) == 4 && c->get(12) == 1;
				break;
	case 4:
		c->insert(0, 2);
		c->insert(0, 1);
		...
		c->insert(1, 1);
		c->insert(2, 2);
		passed = c->length() == 5 && equalsCircle("11227", c) && 
	...
	case 5:
		...
		c->insert(2, 6);
		c->set(0, 9);
		passed = c->length() == 5 && equalsCircle("93623", c);
		break;
	case 6:
		c->insert(0, 1);
		c->insert(1, 3);
		...
		passed = c->length() == 4 && equalsCircle("9348", c);
		break;
	case 7:
		c->insert(0, 1);
		c->insert(1, 3);
		...
		c->set(19, 9);
		c->insert(c->length(), 7);
		passed = c->length() == 6 && equalsCircle("193497", c);
		break;
	case 8:
		c->insert(0, 9);
		tmp = c->subCircle(0, 1);
		c->set(0, 3);
		passed = equalsCircle("9", tmp) && equalsCircle("3", c);
		break;
	case 9:
		c->insert(0, 4);
		tmp = c->subCircle(0, 0);
		c->insert(1, 2);
		passed = equalsCircle("", tmp) && equalsCircle("42", c);
		break;
	case 10:
		c->insert(0, 1);
		c->insert(1, 2);
	...
	case 13:
		c = initCircle("12347");
		passed = c->contains(initCircle("123476")) == -1 && c->contains(initCircle("34")) == 2 && c->contains(initCircle("2347")) == 1;
		break;
	case 14:
		c = initCircle("12347");
		passed = c->contains(initCircle("12347")) == 0 && c->contains(initCircle("01234")) == -1;
		break;
	case 15:
		c = initCircle("12347");
		passed = c->contains(initCircle("47")) == 3 && c->contains(initCircle("23")) == 1;
		break;
	case 16:
		c = initCircle("1");
